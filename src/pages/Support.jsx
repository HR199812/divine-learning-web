...
export default function Support() {
  useEffect(() => { document.title = 'Support — Aradhana Kit' }, [])
  ...
  return (
    <>
      ...
      <div className="faq-section">
        ...
        <div className="faq-group">
          ...
          <details>
            ...
            <div className="faq-answer">Make sure location permission is granted in your device settings (Settings → Aradhana Kit → Location → While Using). The app falls back to New Delhi if permission is denied. Panchang data is fetched from the VedAstro API using your coordinates.</div>
          </details>
          <details>
      ...
      <footer className="legal-footer">
        <p>© 2026 Aradhana Kit &nbsp;·&nbsp; <Link to="/">Home</Link> &nbsp;·&nbsp; <Link to="/privacy-policy">Privacy Policy</Link> &nbsp;·&nbsp; <Link to="/terms">Terms &amp; Conditions</Link></p>
      </footer>
    </>
  )
}
