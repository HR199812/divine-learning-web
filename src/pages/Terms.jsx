...
export default function Terms() {
  useEffect(() => { document.title = 'Terms & Conditions — Aradhana Kit' }, [])
  ...
  return (
    <>
      ...
      <div className="page-wrap">
        ...
        <div className="prose">
          ...
          <div className="highlight-box">
            <strong>Please read carefully.</strong> By downloading or using Aradhana Kit, you agree to be bound by these Terms. If you disagree with any part, please do not use the App.
          </div>

          <h2><i className="fa-solid fa-handshake"></i>1. Acceptance of Terms</h2>
          <p>These Terms and Conditions ("Terms") govern your use of the Aradhana Kit mobile application ("App") and associated website, operated by Justanothersupremesoul ("we", "us", "our"). By accessing or using the App, you confirm that you are at least 13 years of age and agree to these Terms in full.</p>

          <h2><i className="fa-solid fa-mobile-screen"></i>2. Description of Service</h2>
          <p>Aradhana Kit is a free Hindu devotional application that provides:</p>
          <ul>
      ...
      <footer className="legal-footer">
        <p>© 2026 Aradhana Kit &nbsp;·&nbsp; <Link to="/">Home</Link> &nbsp;·&nbsp; <Link to="/privacy-policy">Privacy Policy</Link> &nbsp;·&nbsp; <Link to="/support">Support</Link></p>
      </footer>
    </>
  )
}
